from customer import load_customers, fn1_insert_customer_info, fn2_print_customers, fn3_delete_customer, fn4_search_customer, fn5_save_customer_csv, fn9_save_customer_txt
def main():
